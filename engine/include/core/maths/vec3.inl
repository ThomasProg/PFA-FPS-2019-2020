...
inline
Core::Maths::Vec3::Vec3(decimal x, decimal y, decimal z)
	: x(x), y(y), z(z)
{
...
inline
decimal Core::Maths::Vec3::vectorSquareLength() const
{
	return (x * x + y * y + z * z);
}
...
inline
decimal Core::Maths::Vec3::dotProduct(const Core::Maths::Vec3& u, const Core::Maths::Vec3& v)
{
	return { u.x * v.x 
           + u.y * v.y 
           + u.z * v.z};
...
inline
Core::Maths::Vec3 Core::Maths::Vec3::crossProduct(const Core::Maths::Vec3& v1, const Core::Maths::Vec3& v2)
{
